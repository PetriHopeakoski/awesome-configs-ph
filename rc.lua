...
globalkeys = mytable.join(
    ...
    awful.util.spawn("freetube") end,
			  {description = "launch freetube", group = "launcher"}),
			  
	-- celluloid
    awful.key({ modkey }, "c", function ()
    awful.util.spawn("celluloid") end,
			  {description = "launch celluloid", group = "launcher"}),
    ...
    awful.util.spawn("archlinux-logout") end,
			  {description = "archlinux-logout", group = "launcher"}),
